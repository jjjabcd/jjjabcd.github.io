...
{% include figure.liquid path="/assets/blog/paper-review/2025-02-07-molso/alg1.png" class="img-fluid" caption="Algorithm 1. Find the Pareto front by identifying the set of non-dominated data points." %}
...
{% include figure.liquid path="/assets/blog/paper-review/2025-02-07-molso/alg2.png" class="img-fluid" caption="Algorithm 2. Pareto front ranking of data points." %}
...
{% include figure.liquid loading="eager" path="/assets/blog/paper-review/2025-02-07-molso/fig7.jpg" class="img-fluid rounded z-depth-1" caption="Figure 7. Binding pose of compound A in the DRD2 structure. (A) The ball-and-stick representation shown highlights how the compound fits the broader pocket. (B) The space-fill model highlights the interaction between cyclopropanes and the hydrophobic mouth of the receptor." %}
...
{% include figure.liquid loading="eager" path="/assets/blog/paper-review/2025-02-07-molso/fig8.jpg" class="img-fluid rounded z-depth-1" caption="Figure 8. Effect of Bayesian optimization on the progression of the model in the objective space. The first and second rows represent the scatterplots for random selection and Bayesian optimization strategy, respectively. In each row, the objective space is for the training data and the molecules from the baseline model and retrained model after the first, fifth, and tenth weighted retrainings for k = 1e-3. Higher increase in hypervolume (HV) for the Bayesian optimization strategy shows its effectiveness over random selection." %}
