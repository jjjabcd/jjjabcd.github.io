...
{% include figure.liquid path="/assets/blog/paper-review/2025-02-13-ChemMORT/fig1.jpeg" class="img-fluid" caption="Figure 1. The workflow of ChemMORT." %}
...
{% include figure.liquid path="/assets/blog/paper-review/2025-02-13-ChemMORT/fig2.jpeg" class="img-fluid" caption="Figure 2. The translation accuracy for the training set and test set during the 160 k training steps." %}
...
{% include figure.liquid path="/assets/blog/paper-review/2025-02-13-ChemMORT/fig5.jpeg" class="img-fluid" caption="Figure 5. The top 10 residues contributing to the binding free energies of the generated active molecules. Figures A-F correspond to the binding modes of Olaparib and the optimized molecules 1~5, respectively." %}
