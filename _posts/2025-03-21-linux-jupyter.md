...
Publish Date: 2025년 3월 21일
Category: CS(Computer Science) (https://www.notion.so/CS-Computer-Science-198ee3c1d96b80d98a4df9ba2e004f8f?pvs=21)
...
- [Ubuntu에서 Miniconda 설치](Ubuntu%EC%97%90%EC%84%9C%20Miniconda%20%EC%84%A4%EC%B9%98%201b4ee3c1d96b80168dd7f6604c203330.md)
...
- 주의: 위 방식으로 실행하면 해당 terminal session은 Jupyter 실행 전용이 되며, 다른 명령어를 입력할 수 없습니다.
...
- ex) `jupyter notebook --ip 0.0.0.0` , `jupyter lab --ip 0.0.0.0`
- 모든 IP에서 접근 가능하도록 할 경우 사용

- `--port <번호>`
- Jupyter 서버가 사용할 port를 지정
- ex) `jupyter lab --port 8888` , `jupyter notebook --port 8888`
- 기본 port가 충돌하거나, 특정 port를 사용해야할 때 유용

- `--no-browser`
- Jupyter 실행 시 기본 웹 브라우저를 자동으로 열지 않는다.
- SSH 접속 환경에서는 보통 브라우저가 로컬에 설치되어 있지 않으므로, 이 옵션을 사용
...
[제목 없음](SSH%20%EC%A0%91%EC%86%8D%20%ED%9B%84%20jupyter%20%EC%82%AC%EC%9A%A9/%EC%A0%9C%EB%AA%A9%20%EC%97%86%EC%9D%8C%2019aee3c1d96b811e9c9beec478b16bef.csv)
