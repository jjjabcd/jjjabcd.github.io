...
$$
d_\theta(\theta_1, \theta_2) = d_\theta(\theta_2, \theta_3) \not\Rightarrow d_\pi(\pi_{\theta_1}, \pi_{\theta_2}) = d_\pi(\pi_{\theta_2}, \pi_{\theta_3})
$$

위 수식에서 $$d_\theta$$는 parameter space에서의 distance를 의미하고, $$d_\pi$$는 policy space에서의 distance를 의미한다. 즉, parameter update의 크기를 고정하더라도 실제 policy 변화량은 일정하지 않을 수.
